...
tab1, tab2, tab3 = st.tabs(["##### :blue[***1. Domaine d'études***]", "##### :blue[***2. Professions***]", "##### :blue[***3. Hobbies***]"])
...
with tab2:
    ...
    with col3:
        st.subheader("Métiers masculins :")
        st.pyplot(fig3)
...
with tab3:
    ...
    with col5:
        st.subheader("Hobbies masculins :")
        st.pyplot(fig6)
